...
ed. Benedikt Hallgrímsson and Brian K. Hall.
...
library(readr)
Red_Cell_Size_in_Humans <- read_csv("~/Dropbox/GD_Old_to_Db/Topicos-2016/DATA Analysis for presentation/Roy-Haldane Conjucture/Red Cell Size in Humans.csv")
RBC=Red_Cell_Size_in_Humans
RBC=data.frame(RBC)
head(RBC)
summary(RBC)
names(RBC)
